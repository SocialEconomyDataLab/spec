...
project = 'Social Finance Data Specification (Alpha)'
...
latex_documents = [
    (master_doc, 'sphinx.tex', 'Social Finance Data Specification (Alpha)',
...
man_pages = [
    (master_doc, 'sphinx', 'Social Finance Data Specification (Alpha)',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sphinx', 'Social Finance Data Specification (Alpha)',
     author, 'sphinx', 'The Social Finance Data Specification is being developed as a draft data specification for describing social investment.',
     'Miscellaneous'),
]
