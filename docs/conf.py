...
project = 'Social Investement Data Labs Specification (Alpha)'
...
latex_documents = [
    (master_doc, 'sphinx.tex', 'Social Investement Data Labs Specification (Alpha)',
...
man_pages = [
    (master_doc, 'sphinx', 'Social Investement Data Labs Specification (Alpha)',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sphinx', 'Social Investement Data Labs Specification (Alpha)',
     author, 'sphinx', 'The Social Investement Data Labs Specification is being developed as a draft data specification for describing social investment.',
     'Miscellaneous'),
]
